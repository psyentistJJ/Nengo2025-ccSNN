...
train_weights = (
    False  # TODO: currently means that scaling factors per neurotransmitter is trained - but with tiny lr
)
train_out = True
train_hidden = False
...
specifics = dict(
    ...
    olfactory=dict(  # fruit fly olfactory pathway
        nb_inputs=2264,
        nb_hidden=7616,
        N_cell_types=552,
        nb_outputs=284,
