...
target_weights = 'target_model'
Dales_law=0.7
N_train_only_weights=0

# surrogate gradient scale
surr_grad_scale = 100#100.0
...
target_model = None#target_Lightning.model
params_from_target =None
hidden_in_loss =0.7#None, array of indices, or percentage of hidden units recordings that are provided
hidden_loss_scale=1
noise=None #for parameters that are in both params_from_target and train_intrinsic, add this factor *gaussian noise to the parameter init
...
specifics = dict(
    ...
    shd=dict(  # SHD
        ...
        nb_hidden=128,
        nb_outputs=20,
        N_epochs=10#150,  # double compared to paper
    ),
